...
extension UIViewController {
    ...
    func showVC(_ vcid : VCIdentifier) {
        let vc = self.storyboard!.instantiateViewController(withIdentifier: vcid.rawValue)
    ...
    func getNavVC(for vcid: VCIdentifier) -> UINavigationController {
    ...
    func alertWith(_ title: String = AppName, message: String, doneTitle:String? = "OK", cancelTitle:String? = "Cancel", doneAction:(()->())? = nil, cancelAction:(()->())? = nil) {
...
extension UITextField {
    ...
    func tapOnImgView(_ recognizer: UITapGestureRecognizer) {
